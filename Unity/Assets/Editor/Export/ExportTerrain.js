...
class ExportTerrain extends EditorWindow {
	...
	function Export () {
		Debug.LogWarning("Terrain Exported using Mike's Maya Variant");
		...
		meshScale = Vector3(meshScale.z/(h-1)*tRes, meshScale.y, meshScale.x/(w-1)*tRes); //swapping co-ordinate for Maya
