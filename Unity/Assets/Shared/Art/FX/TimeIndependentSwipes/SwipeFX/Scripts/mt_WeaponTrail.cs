...
//
class mt_TronTrailSection
{
	public Vector3 point;
    public Vector3 upDir;
    public float time;
    public mt_TronTrailSection() {

    }
    public mt_TronTrailSection(Vector3 p, float t) {
        point = p;
        time = t;
    }
}
...
public class mt_WeaponTrail : MonoBehaviour {
    ...
    */
    ...
    Vector3 position;
    float now = 0;
    mt_TronTrailSection currentSection;
    ...
    private List<mt_TronTrailSection> sections = new List<mt_TronTrailSection>();
