...
public class DemoSwipeMenuCS_mton : MonoBehaviour
{
  ...
  private const string 
    MENU_SCENE_NAME				= "CF-Demo-CS-Menu_mton",
                          ...
                          AUDIO_DEMO_MTON_NAME        = "SoundGenPlatformer_CoreKit";

  public const int ITEM_AUD       = 0;
  public const int ITEM_DSS 		= 1;
  public const int ITEM_FPP 		= 2;
  public const int ITEM_RPG 		= 3;
  public const int ITEM_MAP 		= 4;
  ...
  {	
    ...
    if (this.menu.JustCompleted())
    {
      switch (this.menu.GetCurItem())
      {
        ...
        case ITEM_AUD :
          this.StartDemo(AUDIO_DEMO_MTON_NAME);
          return;	
  ...
  private void OnGUI()	
  {
    ...
    for (int i = 0; i < ITEM_COUNT; ++i)
    {
      ...
      switch (i)
      {
        ...
        case ITEM_AUD : 
          img = this.imgAud; descText = AUD_DEMO_DESCRIPTION; break;
        case ITEM_DSS : 
