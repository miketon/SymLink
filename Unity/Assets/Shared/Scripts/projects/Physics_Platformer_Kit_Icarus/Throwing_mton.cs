...
[RequireComponent(typeof(PlayerMove_mton))]
public class Throwing_mton : MonoBehaviour 
{
	...
	public Animator animator;									//object with animation controller on, which you want to animate (usually same as in PlayerMove_mton)
	...
	private PlayerMove_mton playerMove;
	...
	void Awake()
	{
		...
		playerMove = GetComponent<PlayerMove_mton>();
