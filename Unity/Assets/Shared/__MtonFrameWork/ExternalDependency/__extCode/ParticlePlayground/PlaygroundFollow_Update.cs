...
//		public class PlaygroundFollow_Update : MonoBehaviour {
//			
//			/// <summary>
...
//			/// </summary>
//			/// <param name="particle">Particle.</param>
//			public virtual void OnParticleDidDie (PlaygroundEventParticle particle) { //MTON : Changed to be overrideable
