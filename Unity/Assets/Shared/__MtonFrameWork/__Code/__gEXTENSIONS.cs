...
public static class __gEXTENSIONS {
	...
	public static void doAimTowardsZ(this Transform self, Vector3 IN_POS_TGT, float IN_FACING = 1.0f, float IN_ROTSPEED = 8.0f){ //IN_FACING = 1.0f forward, -1.0f reverse
